...
const insertOneResult = db.equipment.insertOne({
...
const insertManyResult = db.equipment.insertMany([
    {
...
print("insertMany Result Count: " + Object.keys(insertManyResult.insertedIds).length);
...
const updateOneResult = db.equipment.updateOne(
    { equipmentName: "Oscilloscope" },
    {
        $set: {
            condition: "Good",
...
const updateManyResult = db.equipment.updateMany(
    { availableQuantity: 0 },
    {
...
const deleteOneResult = db.equipment.deleteOne({ equipmentName: "Function Generator" });
